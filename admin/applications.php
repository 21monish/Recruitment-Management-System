						...
						<div class="row">
							<div class="col-lg-12">
								...
								<button class="btn btn-sm btn-block btn-primary btn-sm col-md-2 float-right"
									type="button" id="new_application"><i class="fa fa-plus"></i> New Applicant</button>
							</div>
						</div>
					...
					<div class="card-body">
							...
							<div class="col-lg-12">
								<div class="row">
									...
									<div class="col-md-5">
										<select name="" class="custom-select browser-default select2"
											...
											<?php foreach ($pos as $k => $v): ?>
												<option value="<?php echo $k ?>" <?php echo isset($position_id) && $position_id == $k ? "selected" : '' ?>>
													<?php echo $v ?>
												</option>
											<?php endforeach; ?>
										</select>
									...
									<div class="col-md-2">
										...
										<a href="export.php" class="btn btn-success"> <i class="fas fa-file-export"></i>
											Export</a>
									</div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								// 	$awhere = " where a.process_id = '".$_POST['pid']."' ";
								// }
								if (isset($_GET['position_id']) && $_GET['position_id'] > 0) {
								...
								//$application = $conn->query("SELECT * FROM application where position_id='9'");
